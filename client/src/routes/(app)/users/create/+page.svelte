...
<main class="container">
  <article>
    <hgroup>
      ...
      <p>
        They'll get an email with a link to set up their account. This is the only way new accounts
        get created.
      </p>
    </hgroup>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      ...
      <button type="submit" aria-busy={status === 'submitting'} disabled={status === 'submitting'}>
